...
public class BattleTile {
	...
	/**
	 * Originalno polje na ploèi na koje se primjenjuju bonusi.
	 */
	...
	/**
	 * Getter za x koordinatu polja sadržanog unutar instance polja u borbi (engl. <i>BattleTile</i>).
	...
	/**
	 * Getter za y koordinatu polja sadržanog unutar instance polja u borbi (engl. <i>BattleTile</i>).
